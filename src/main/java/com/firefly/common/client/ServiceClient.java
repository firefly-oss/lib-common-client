...
package com.firefly.common.client;
...
public interface ServiceClient {
     ...
     */
    static com.firefly.common.client.builder.RestClientBuilder rest(String serviceName) {
        return new com.firefly.common.client.builder.RestClientBuilder(serviceName);
    }
     ...
     */
    static <T> com.firefly.common.client.builder.GrpcClientBuilder<T> grpc(String serviceName, Class<T> stubType) {
